...
void Vaccine::showData()//3
{
    ...
    cout<<"\n\t\t\t*****************************************\n\n";
  	cout<<"\t\t Name is: "<<name<<endl;
   	cout<<"\t\t registration number is: "<<registration<<endl;
...
void Vaccine::searchData()//6
{
    ...
    cout<<"\n\t\t 1. By registration No. \t\t 2. By Age "<<endl;
...
void Vaccine::search_by_registration()//6.1
{
    ifstream in;
    ...
    if(flag=0)
    {
    	    cout<<"registration you entered doesnot exist";
	}
...
int password()//b
{
    ...
    if( (strcmp(cname,"dyp")==0) && (strcmp(pass,"123")==0))
        return 1;
    else
        return 0;
}
